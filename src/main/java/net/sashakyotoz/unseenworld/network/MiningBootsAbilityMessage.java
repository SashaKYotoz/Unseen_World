...
public class MiningBootsAbilityMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		UnseenWorldMod.addNetworkMessage(MiningBootsAbilityMessage.class, MiningBootsAbilityMessage::buffer, MiningBootsAbilityMessage::new, MiningBootsAbilityMessage::handler);
	}
}
