...
public class UnseenWorldModPotions {
	...
	public static final RegistryObject<Potion> DARK_VOID_POTION = REGISTRY.register("dark_void_potion",
			() -> new Potion(new MobEffectInstance(UnseenWorldModMobEffects.DARK_VOID.get(), 200, 0, false, true), new MobEffectInstance(UnseenWorldModMobEffects.DARK_VOID.get(), 60, 0, false, true)));
