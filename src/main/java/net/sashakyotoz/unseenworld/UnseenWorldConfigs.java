...
public class UnseenWorldConfigs {
	...
	public static final ForgeConfigSpec.BooleanValue SHOW_CUSTOM_PANORAMA;
	static {
		...
		SHOW_CUSTOM_PANORAMA = BUILDER.comment("Enable panorama of Unseen World.").define("panorama_unseen_world", false);
		BUILDER.pop();
		SPEC = BUILDER.build();
	}
}
