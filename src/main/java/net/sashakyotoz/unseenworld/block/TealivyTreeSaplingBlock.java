...
import net.sashakyotoz.unseenworld.procedures.TealivyTreeSaplingUpdateTickProcedure;
...
public class TealivyTreeSaplingBlock extends FlowerBlock implements BonemealableBlock {
	public TealivyTreeSaplingBlock() {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		TealivyTreeSaplingUpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
