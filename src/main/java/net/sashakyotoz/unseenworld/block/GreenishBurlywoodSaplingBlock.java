...
import net.sashakyotoz.unseenworld.procedures.GreenishBurlywoodSaplingUpdateTickProcedure;
...
public class GreenishBurlywoodSaplingBlock extends FlowerBlock implements BonemealableBlock {
	public GreenishBurlywoodSaplingBlock() {
		super(() -> MobEffects.INVISIBILITY, 200, BlockBehaviour.Properties.copy(Blocks.OAK_SAPLING).randomTicks().sound(SoundType.GRASS).instabreak().noCollission());
	}
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		GreenishBurlywoodSaplingUpdateTickProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}
