...
import net.sashakyotoz.unseenworld.procedures.DarkCrimsonBloomingVineUpdateTickProcedure;
...
public class DarkCrimsonBloomingVineBlock extends Block {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		DarkCrimsonBloomingVineUpdateTickProcedure.execute(world, x, y, z);
	}
}
