...
public class ModelStreder<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("unseen_world", "model_streder"), "main");
	...
	public ModelStreder(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = upperSpikes.addOrReplaceChild("cube_r1",
		...
		PartDefinition cube_r2 = rightSpikes.addOrReplaceChild("cube_r2",
		...
		PartDefinition cube_r3 = leftSpikes.addOrReplaceChild("cube_r3",
		...
		PartDefinition cube_r4 = rightLeg.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 30).mirror().addBox(-1.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition cube_r5 = leftLeg.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 30).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0436F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.upperSpikes.xRot = headPitch / (180F / (float) Math.PI);
	}
}
