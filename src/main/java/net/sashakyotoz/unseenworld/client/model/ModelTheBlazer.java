...
public class ModelTheBlazer<T extends TheBlazerEntity> extends HierarchicalModel<T> {
	...
	public ModelTheBlazer(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(73, 0).mirror().addBox(-5.0F, -7.0F, -5.0F, 10.0F, 12.0F, 10.0F, new CubeDeformation(0.25F)).mirror(false)
				.texOffs(0, 0).mirror().addBox(-5.0F, -7.0F, -5.0F, 10.0F, 12.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(41, 0).addBox(-4.0F, -6.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));
		...
		PartDefinition cube_r2 = right_forward.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(12, 32).mirror().addBox(-5.5F, -7.75F, -1.0F, 11.0F, 18.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 7.5F, -2.0F, -0.3491F, 0.0F, 0.0F));

		PartDefinition right_back = Body.addOrReplaceChild("right_back", CubeListBuilder.create(), PartPose.offset(-6.0F, 0.0F, 0.0F));

		PartDefinition cube_r3 = right_back.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(12, 32).mirror().addBox(-5.5F, -7.5F, -0.5F, 11.0F, 18.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.5F, 7.0F, 0.0F, -0.3491F, 1.5708F, 0.0F));

		PartDefinition left_forward = Body.addOrReplaceChild("left_forward", CubeListBuilder.create(), PartPose.offset(6.0F, 0.0F, 0.0F));

		PartDefinition cube_r4 = left_forward.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-5.5F, -8.0F, -0.8F, 11.0F, 18.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0F, 7.5F, 0.0F, 0.3491F, 1.5708F, 0.0F));

		PartDefinition left_back = Body.addOrReplaceChild("left_back", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 6.0F));

		PartDefinition cube_r5 = left_back.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-5.5F, -8.0F, 0.0F, 11.0F, 18.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 8.0F, 2.0F, 0.3491F, 0.0F, 0.0F));
		...
		PartDefinition rods = Body.addOrReplaceChild("rods", CubeListBuilder.create().texOffs(52, 18).mirror().addBox(-1.2F, -11.0F, -1.7F, 3.0F, 20.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(52, 41).mirror().addBox(-1.1824F, -11.5F, -1.7F, 3.0F, 20.0F, 3.0F, new CubeDeformation(1.0F)).mirror(false)
