...
public class ModelWarrior_of_the_Chimeric_Darkness<T extends DarkGolemEntity> extends HierarchicalModel<T> implements ArmedModel {
	...
	public ModelWarrior_of_the_Chimeric_Darkness(ModelPart root) {
		this.root = root;
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(entity.attackAnimationState, DarkGolemAnimations.ATTACK, ageInTicks);
	...
	public void translateToHand(HumanoidArm p_102854_, PoseStack p_102855_) {
		...
		p_102855_.translate(0.5F, 0.25F, 0.0F);
	}
