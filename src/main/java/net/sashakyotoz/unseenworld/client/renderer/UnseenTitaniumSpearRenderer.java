...
public class UnseenTitaniumSpearRenderer extends EntityRenderer<UnseenTitaniumSpearEntity> {
	...
	@Override
	public void render(UnseenTitaniumSpearEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
