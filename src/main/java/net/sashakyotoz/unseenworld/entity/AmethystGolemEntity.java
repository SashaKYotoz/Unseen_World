...
public class AmethystGolemEntity extends TamableAnimal {
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.amethyst_cluster.hit"));
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		AmethystGolemEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AmethystGolemEntity retval = UnseenWorldModEntities.AMETHYST_GOLEM.get().create(serverWorld);
