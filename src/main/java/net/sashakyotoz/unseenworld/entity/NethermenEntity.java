...
public class NethermenEntity extends EnderMan {
	private int attackAnimationRemainingTicks;

	public NethermenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UnseenWorldModEntities.NETHERMEN.get(), world);
	}

	public NethermenEntity(EntityType<NethermenEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ambient.nether_wastes.additions"));
	}
