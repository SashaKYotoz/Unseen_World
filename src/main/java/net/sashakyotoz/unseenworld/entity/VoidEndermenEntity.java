...
public class VoidEndermenEntity extends EnderMan {
	private int attackAnimationRemainingTicks;

	public VoidEndermenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UnseenWorldModEntities.VOID_ENDERMEN.get(), world);
	}

	public VoidEndermenEntity(EntityType<VoidEndermenEntity> type, Level world) {
		super(type, world);
		xpReward = 6;
		setNoAi(false);
	}
	...
	public boolean doHurtTarget(Entity p_34491_) {
		if (!(p_34491_ instanceof LivingEntity)) {
			...
			return VoidEndermenEntity.hurtAndThrowTarget(this, (LivingEntity) p_34491_);
		}
	}
