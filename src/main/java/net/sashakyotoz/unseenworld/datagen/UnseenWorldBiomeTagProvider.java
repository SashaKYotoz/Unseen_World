...
public class UnseenWorldBiomeTagProvider extends BiomeTagsProvider {
    ...
    public UnseenWorldBiomeTagProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> future, @Nullable ExistingFileHelper existingFileHelper) {
