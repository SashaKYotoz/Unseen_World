...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    public void generate() {
        ...
        this.dropSelf(UnseenWorldModBlocks.DARK_CRIMSON_FLOWING_AZALIA.get());
...
//        grass blocks
    ...
    public Iterable<Block> getKnownBlocks() {
        return UnseenWorldModBlocks.BLOCKS.getEntries().stream().map(RegistryObject::get)::iterator;
    }
}
...
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("slab"))
//                .forEach(block -> this.add(block, createSlabItemTable(block)));
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("fence"))
//                .forEach(this::dropSelf);
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("wall"))
//                .forEach(this::dropSelf);
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("pressure_plate"))
//                .forEach(this::dropSelf);
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("log"))
//                .forEach(this::dropSelf);
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("door"))
//                .forEach(block -> this.add(block, createDoorTable(block)));
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("trapdoor"))
//                .forEach(this::dropSelf);
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("sapling"))
//                .forEach(this::dropSelf);
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("grass_block"))
//                .forEach(this::dropSelf);
//        Arrays.stream(allBlocks).sequential()
//                .filter(block -> block.getDescriptionId().contains("button"))
//                .forEach(this::dropSelf);