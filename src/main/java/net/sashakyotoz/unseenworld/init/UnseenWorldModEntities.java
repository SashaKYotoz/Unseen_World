...
public class UnseenWorldModEntities {
	...
	public static final RegistryObject<EntityType<RedSlylfEntity>> RED_SLYLF = register("red_slylf",
			EntityType.Builder.<RedSlylfEntity>of(RedSlylfEntity::new, MobCategory.AMBIENT).setShouldReceiveVelocityUpdates(true).setTrackingRange(16).setUpdateInterval(3).setCustomClientFactory(RedSlylfEntity::new).fireImmune().sized(0.6f, 0.8f));
