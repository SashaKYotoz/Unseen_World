			...
			for (int index0 = 0; index0 < (int) Mth.nextDouble(RandomSource.create(), 1, 3); index0++) {
				if (Math.random() < 0.125) {
					...
					if (world instanceof ServerLevel _level)
						_level.sendParticles((SimpleParticleType) (UnseenWorldModParticleTypes.REDNESS.get()), (x + Mth.nextDouble(RandomSource.create(), -5, 5)), (y + 5), (z + Mth.nextDouble(RandomSource.create(), -5, 5)), 9, 5, 5, 5, 1);
				} else {
					break;
				}
			}
