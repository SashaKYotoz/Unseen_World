...
public class MiningbootsProcudeProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getEnchantmentLevel(UnseenWorldModEnchantments.MININGBOOTS.get()) > 0) {
			...
			}
			{
				...
				if (_ist.hurt((int) (Mth.nextDouble(RandomSource.create(), 1, 6) - (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getEnchantmentLevel(Enchantments.UNBREAKING)),
