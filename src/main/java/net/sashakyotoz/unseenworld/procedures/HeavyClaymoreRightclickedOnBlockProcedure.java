...
public class HeavyClaymoreRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == UnseenWorldModBlocks.BEACON_OF_WEAPONS.get() && (world.getBlockState(BlockPos.containing(x + 2, y, z))).getBlock() == UnseenWorldModBlocks.BEACON_RUNE.get()
			...
			if (itemstack.getItem() == UnseenWorldModItems.HEAVY_CLAYMORE.get() && (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(UnseenWorldModItems.VOID_INGOT_INGOT.get())) : false)) {
			...
			} else if (itemstack.getItem() == UnseenWorldModItems.HEAVY_CLAYMORE.get() && (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(UnseenWorldModItems.NATURERIUM_INGOT.get())) : false)) {
				if (entity instanceof Player _player) {
			...
			} else if (itemstack.getItem() == UnseenWorldModItems.HEAVY_CLAYMORE.get() && (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(UnseenWorldModItems.RED_TITANIUM_INGOT.get())) : false)) {
				if (entity instanceof Player _player) {
