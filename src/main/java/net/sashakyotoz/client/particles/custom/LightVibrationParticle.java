...
public class LightVibrationParticle extends SpriteBillboardParticle {
    ...
    LightVibrationParticle(ClientWorld world, double x, double y, double z, PositionSource vibration, int maxAge) {
    ...
    public void tick() {
        ...
        if (this.age++ >= this.maxAge) {
            ...
            if (optional.isEmpty()) {
                ...
                int color = Color.HSBtoRGB(WorldClientTickEventHandler.halfTicks.get(0) == null ? 0 : WorldClientTickEventHandler.halfTicks.get(0) / 10 % 360, 1F, 1.0F);
    ...
    public static class Factory implements ParticleFactory<LightVibrationParticleEffect> {
        ...
        public Particle createParticle(
                LightVibrationParticleEffect vibrationParticleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i
        ) {
