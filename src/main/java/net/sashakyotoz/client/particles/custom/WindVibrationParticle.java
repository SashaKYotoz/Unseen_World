...
public class WindVibrationParticle extends SpriteBillboardParticle {
    ...
    WindVibrationParticle(ClientWorld world, double x, double y, double z, PositionSource vibration, int maxAge) {
    ...
    public static class Factory implements ParticleFactory<WindVibrationParticleEffect> {
        ...
        public Particle createParticle(
                WindVibrationParticleEffect vibrationParticleEffect, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i
        ) {
            WindVibrationParticle vibrationParticle = new WindVibrationParticle(
