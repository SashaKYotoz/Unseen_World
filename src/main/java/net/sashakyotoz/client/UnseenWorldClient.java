...
public class UnseenWorldClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        HandledScreens.register(
                ...
                new HandledScreens.Provider<ChestScreenHandler, CottonInventoryScreen<ChestScreenHandler>>() {
                    @Override
                    public CottonInventoryScreen<ChestScreenHandler> create(
                            ChestScreenHandler handler,
                            PlayerInventory inv,
                            Text title
                    ) {
                        return new CottonInventoryScreen<>(handler, inv.player, title);
                    }
                }
        );
