...
public class GuardianItemFeatureRenderer<T extends ViolegerEntity, M extends EntityModel<T> & ModelWithArms> extends FeatureRenderer<T, M> {
    private final HeldItemRenderer heldItemRenderer;

    public GuardianItemFeatureRenderer(FeatureRendererContext<T, M> context, HeldItemRenderer heldItemRenderer) {
        super(context);
    ...
    public void render(
        ...
        if (!itemStack.isEmpty() || !itemStack2.isEmpty()) {
            ...
            if (livingEntity.isHostile()) {
                ...
                matrixStack.translate(0.0F, 0.45F, -0.35F);
                matrixStack.multiply(RotationAxis.POSITIVE_X.rotationDegrees(180.0F));
                ItemStack stack = livingEntity.getEquippedStack(EquipmentSlot.MAINHAND);
                this.heldItemRenderer.renderItem(livingEntity, stack, ModelTransformationMode.GROUND, false, matrixStack, vertexConsumerProvider, i);
            }
            matrixStack.pop();
        }
    }
