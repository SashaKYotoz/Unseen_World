...
public class TranslocatoneBlock extends BlockWithEntity {
    public static final BooleanProperty TRIGGERED = Properties.TRIGGERED;
    private final VoxelShape STONE_SHAPE = VoxelShapes.union(
            TranslocatoneBlock.createCuboidShape(0, 0, 0, 16, 3, 16),
            TranslocatoneBlock.createCuboidShape(1, 4, 1, 15, 5, 15),
            TranslocatoneBlock.createCuboidShape(3, 5, 3, 13, 11, 13),
            TranslocatoneBlock.createCuboidShape(1, 11, 1, 12, 13, 12),
            TranslocatoneBlock.createCuboidShape(0, 13, 0, 16, 16, 16));

    public TranslocatoneBlock(Settings settings) {
        super(settings);
