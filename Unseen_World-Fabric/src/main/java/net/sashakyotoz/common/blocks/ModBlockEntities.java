...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<TranslocatoneBlockEntity> TRANSLOCATONE = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE,
    ...
    public static final BlockEntityType<SusBlockEntity> SUSBLOCK = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE,
    ...
    public static final BlockEntityType<DarkCurranslateChestEntity> DARK_CURRANTSLATE_CHEST = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE,
    ...
    public static final BlockEntityType<GlaciemiteChestEntity> GLACIEMITE_CHEST = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE,
    ...
    public static final BlockEntityType<OrdealSpawnerBlockEntity> ORDEAL_SPAWNER = Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE,
