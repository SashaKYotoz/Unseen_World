...
public class GrippingCrystalProjectileEntity extends PersistentProjectileEntity {
    ...
    public void tick() {
        ...
        if (!this.inGround && this.age % 5 == 0 && this.getWorld() instanceof ServerWorld world)
            world.spawnParticles(ModParticleTypes.GRIPPING_CRYSTAL,
                    ...
                    ActionsUtils.getXVector(1, this.getYaw()),
                    ActionsUtils.getYVector(-1, this.getPitch()),
                    ActionsUtils.getZVector(1, this.getYaw()), 1);
    ...
    protected void onBlockHit(BlockHitResult blockHitResult) {
        ...
        ActionsUtils.spawnParticle(ModParticleTypes.GRIPPING_CRYSTAL,
                this.getWorld(), this.getX(), this.getY() + 1.5, this.getZ(), 2);
