...
public class ModEntities {
    ...
    public static final EntityType<ViolegerEntity> VIOLEGER = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("violeger"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, ViolegerEntity::new)
                    .dimensions(EntityDimensions.fixed(0.8f, 1.9f)).build());
    public static final EntityType<VenomerEntity> VENOMER = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("venomer"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, VenomerEntity::new)
                    .dimensions(EntityDimensions.fixed(0.8f, 1.9f)).build());
    ...
    public static final EntityType<GrippingGloomwhaleEntity> GRIPPING_GLOOMWHALE = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("gripping_gloomwhale"), FabricEntityTypeBuilder.create(SpawnGroup.WATER_CREATURE, GrippingGloomwhaleEntity::new)
                    .dimensions(EntityDimensions.fixed(3.5f, 2.5f)).build());
    public static final EntityType<ShimmerEntity> SHIMMER = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("shimmer"), FabricEntityTypeBuilder.create(SpawnGroup.WATER_CREATURE, ShimmerEntity::new)
    ...
    public static final EntityType<ReaverEntity> REAVER = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("reaver"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ReaverEntity::new)
    ...
    public static final EntityType<DreadflapEntity> DREADFLAP = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("dreadflap"), FabricEntityTypeBuilder.create(SpawnGroup.AMBIENT, DreadflapEntity::new)
                    .dimensions(EntityDimensions.fixed(0.7F, 1.1F)).build());
    public static final EntityType<VexalBeetleEntity> VEXAL_BEETLE = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("vexal_beetle"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, VexalBeetleEntity::new)
    ...
    public static final EntityType<EclipseSentinel> ECLIPSE_SENTINEL = Registry.register(Registries.ENTITY_TYPE,
            UnseenWorld.makeID("eclipse_sentinel"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, EclipseSentinel::new)
