...
public class ModMessages {
    public static final ResourceLocation GRIPCRYSTAL_ABILITY_HANDLER = UnseenWorld.makeID("gripcrystal_weapons_handler");
    public static final ResourceLocation ABILITY_CLICK_HANDLER = UnseenWorld.makeID("left_click_handler");

    public static final ResourceLocation GRIPCRYSTAL_MANA_HANDLER = UnseenWorld.makeID("gripcrystal_mana_handler");
    public static final ResourceLocation WEATHER_PACKET_ID = UnseenWorld.makeID("weather_sync");
