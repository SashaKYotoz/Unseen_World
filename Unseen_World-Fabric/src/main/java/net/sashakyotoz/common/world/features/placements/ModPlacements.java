...
public class ModPlacements {
    ...
    public static final RegistryKey<PlacedFeature> UNSEENIUM_CURRANTSLATE_DISK = create("unseenium_currantslate_disk");
    public static final RegistryKey<PlacedFeature> TITANIUM_CURRANTSLATE_DISK = create("titanium_currantslate_disk");
    ...
    public static void boostrap(Registerable<PlacedFeature> context) {
        ...
        register(context, AMETHYST_CEILING_BOULDER, configLookup.getOrThrow(ModConfiguredFeatures.AMETHYST_CEILING_BOULDER),
                ...
                EnvironmentScanPlacementModifier.of(Direction.DOWN, BlockPredicate.solid(), BlockPredicate.IS_AIR, 6),
        ...
        register(
                ...
                SquarePlacementModifier.of(),
                BlockFilterPlacementModifier.of(BlockPredicate.matchingBlocks(List.of(ModBlocks.TANZANITE_BLOCK, Blocks.CALCITE))),
                BiomePlacementModifier.of()
        );
        register(
                context,
