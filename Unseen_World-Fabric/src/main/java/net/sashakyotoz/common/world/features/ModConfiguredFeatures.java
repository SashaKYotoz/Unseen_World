...
public class ModConfiguredFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> UNSEENIUM_CURRANTSLATE_DISK = create("unseenium_currantslate_disk");
    public static final RegistryKey<ConfiguredFeature<?, ?>> TITANIUM_CURRANTSLATE_DISK = create("titanium_currantslate_disk");
    ...
    public static void boostrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, UNSEENIUM_ORE, Feature.ORE, new OreFeatureConfig(unseeniumOres, 4, 0.25f));
        register(context, RED_TITANIUM_ORE, Feature.ORE, new OreFeatureConfig(titaniumOres, 2, 0.1f));
        register(context, ABYSSAL_ORE, Feature.ORE, new OreFeatureConfig(abyssalOres, 4, 0.25f));
        register(context, IRON_ORE, Feature.ORE, new OreFeatureConfig(ironOres, 6, 0.5f));
        ...
        register(context, UNSEENIUM_CURRANTSLATE_DISK, DiskOreFeature.INSTANCE, new DiskOreFeatureConfig(
                PredicatedStateProvider.of(ModBlocks.DARK_CURRANTSLATE), PredicatedStateProvider.of(ModBlocks.UNSEENIUM_ORE_IN_DARK_CURRANTSLATE),
                BlockPredicate.matchingBlocks(List.of(ModBlocks.TANZANITE_BLOCK, Blocks.CALCITE)), UniformIntProvider.create(2, 5), 2));
