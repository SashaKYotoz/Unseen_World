...
public class WindVibrationParticle extends TextureSheetParticle {
    ...
    WindVibrationParticle(ClientLevel world, double x, double y, double z, PositionSource vibration, int maxAge) {
    ...
    public static class Factory implements ParticleProvider<WindVibrationParticleEffect> {
        ...
        public Particle createParticle(
                WindVibrationParticleEffect vibrationParticleEffect, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i
        ) {
