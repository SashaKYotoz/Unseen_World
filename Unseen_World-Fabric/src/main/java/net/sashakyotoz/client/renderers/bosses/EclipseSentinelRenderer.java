...
public class EclipseSentinelRenderer extends DeathFixedMobRenderer<EclipseSentinel, EclipseSentinelModel> {
    ...
    @Override
    public void render(EclipseSentinel sentinel, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
    ...
    @Override
    public Identifier getTexture(EclipseSentinel entity) {
